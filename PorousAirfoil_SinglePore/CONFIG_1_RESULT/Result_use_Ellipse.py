...
df = pd.read_csv("CONFIG_1_RESULT/resultats_simulations_Ellipse4.csv")
...
#%% Case 2
# Lecture du fichier CSV
df = pd.read_csv("CONFIG_1_RESULT/resultats_simulations_Ellipse5.csv")
...
#%% Case 3
# Lecture du fichier CSV
df = pd.read_csv("CONFIG_1_RESULT/resultats_simulations_Ellipse6.csv")
